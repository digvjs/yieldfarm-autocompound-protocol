...
contract StratVLEV is Ownable, ReentrancyGuard, Pausable {
    ...
    constructor(
        ...
        earnedToFASTPath = [venusAddress, wbnbAddress, FASTAddress];
    ...
    function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        ...
        // Burn FAST tokens
        uint256 burnAmt = IERC20(FASTAddress).balanceOf(address(this));
        IERC20(FASTAddress).safeTransfer(buyBackAddress, burnAmt);
