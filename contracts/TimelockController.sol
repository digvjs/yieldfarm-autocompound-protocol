...
import "./interfaces/IFastYield.sol";
...
contract TimelockController is AccessControl {
    ...
    function executeSet(
        ...
        _beforeCall(predecessor);
        IFastYield(_fastyieldAddress).set(_pid, _allocPoint, _withUpdate);
        _afterCall(id);
    }
    ...
    function add(
        ...
        IFastYield(_fastyieldAddress).add(0, _want, _withUpdate, _strat); // allocPoint = 0. Schedule set (timelocked) to increase allocPoint.
    }
