...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-FAST staking vault.
    ...
    address public fastYieldAddress;
    ...
    address[] public earnedToFASTPath;
    ...
    constructor(
        ...
        fastYieldAddress = _fastYieldAddress;
        FASTAddress = _FASTAddress;
        ...
        if (isAutoComp) {
            ...
            earnedToFASTPath = [earnedAddress, wbnbAddress, FASTAddress];
            if (wbnbAddress == earnedAddress) {
                earnedToFASTPath = [wbnbAddress, FASTAddress];
            }
        ...
        transferOwnership(fastYieldAddress);
    }
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(fastYieldAddress, _wantAmt);
